 ...
 * @author oscar
 */
public class WarningAlertIE extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public WarningAlertIE(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarActionPerformed
        int imp = Opciones.imprimirE(Integer.parseInt(this.id.getText()));
            if (imp != 0) {
                Opciones.listar("");
                this.dispose();
                SuccessAlert sa = new SuccessAlert(new JFrame(), true);
                sa.titulo.setText("¡HECHO!");
                sa.msj.setText("SE HA GENERADO UN");
                sa.msj1.setText("ARCHIVO A IMPRIMIR");
                sa.setVisible(true);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WarningAlertIE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                WarningAlertIE dialog = new WarningAlertIE(new javax.swing.JFrame(), true);
