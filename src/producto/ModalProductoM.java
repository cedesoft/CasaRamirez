...
public class ModalProductoM extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tipo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ELEGIR CANTIDAD", "NO", "SI" }));
    ...
    private void registrarKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_registrarKeyTyped
        if ((evt.getKeyChar() == KeyEvent.VK_ENTER)) {
            if (this.nombre.getText().equals("") || this.descripcion.getText().equals("")
                ...
                ea.msj.setText("HAY CAMPOS VACIOS");
                ea.msj1.setText("");
                ea.setVisible(true);
                ...
                if (this.registrar.getText().equals("GUARDAR")) {
                    ...
                    producto.Sentencias ps = new Sentencias();

                    ps.setNombre(this.nombre.getText());
                    ps.setDescripcion(this.descripcion.getText());
                    ps.setTipo(this.tipo.getSelectedItem().toString());
                    ps.setPrecio(Double.parseDouble(this.precio.getText()));
                    ps.setId(Integer.parseInt(this.id.getText()));

                    int validaStock = 0;
                    if (!this.stock.getText().equals("")) {
                        validaStock = Integer.parseInt(this.stock.getText());
                        ps.setStock(String.valueOf(validaStock));
                    } else {
                        ps.setStock("");
                    }

                    int opcion = producto.Opciones.actualizar(ps);
                    if (opcion != 0) {
                        String fila = this.id.getText();
                        Opciones.listar("");
                        Productos.seleccionaFila(fila);
                    ...
                    int opcion = producto.Opciones.registrar(ps);
                    if (opcion != 0) {
                        String fila = String.valueOf(Opciones.extraerID());
                        limpiarCampos();
                        Productos.seleccionaFila(fila);
