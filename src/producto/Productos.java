...
import alertas.principal.WarningAlertIE;
...
public class Productos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        imprimiretiqueta = new principal.MaterialButton();
        ...
        imprimiretiqueta.setBackground(new java.awt.Color(58, 159, 171));
        imprimiretiqueta.setForeground(new java.awt.Color(255, 255, 255));
        imprimiretiqueta.setText("IMPRIMIR ETIQUETA");
        imprimiretiqueta.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        imprimiretiqueta.setFont(new java.awt.Font("Roboto Medium", 1, 14)); // NOI18N
        imprimiretiqueta.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                imprimiretiquetaActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(nuevo, javax.swing.GroupLayout.PREFERRED_SIZE, 168, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(eliminarTodo, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(imprimiretiqueta, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(imprimiretiqueta, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel7, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void eliminarTodoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarTodoActionPerformed
        if (this.tabla.getRowCount() < 1) {
            ...
            wa.msj.setText("SE BORRARÁN TODOS LOS");
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        if (this.tabla.getRowCount() < 1) {
            ...
            if (this.tabla.getSelectedRowCount() < 1) {
                ...
                wa.titulo.setText("¿ESTÁS SEGURO?");
                wa.msj.setText("SE BORRARÁN PERMANENTEMENTE");
                wa.msj1.setText("");
                wa.setVisible(true);
            }
        }
    ...
    private void buscarKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyTyped
        ...
        if (Character.isLowerCase(letras)) {
            String bus = ("" + letras).toUpperCase();
            letras = bus.charAt(0);
            evt.setKeyChar(letras);
        }
    }//GEN-LAST:event_buscarKeyTyped

    private void imprimiretiquetaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imprimiretiquetaActionPerformed
        if (this.tabla.getRowCount() < 1) {
            ErrorAlert er = new ErrorAlert(new JFrame(), true);
            er.titulo.setText("OOPS...");
            er.msj.setText("LA TABLA ESTA VACÍA");
            ...
            if (this.tabla.getSelectedRowCount() < 1) {
                ...
                int fila = this.tabla.getSelectedRow();
                WarningAlertIE wa = new WarningAlertIE(new JFrame(), true);
                wa.id.setText(this.tabla.getValueAt(fila, 0).toString());
                wa.titulo.setText("¿ESTÁS SEGURO?");
                wa.msj.setText("SE CREARÁ UN ARCHIVO ");
                wa.msj1.setText("A IMPRIMIR");
                wa.setVisible(true);
            }
        }
    }//GEN-LAST:event_imprimiretiquetaActionPerformed
    ...
    private principal.MaterialButton imprimiretiqueta;
