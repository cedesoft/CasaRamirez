...
public class ModalCorteDia extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnVender1.setText("IMPRIMIR SALIDAS");
        ...
        panel3.add(btnVender1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 580, 170, 50));
        ...
        panel3.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 580, 190, 40));

        btnVender2.setBackground(new java.awt.Color(58, 159, 171));
        btnVender2.setForeground(new java.awt.Color(255, 255, 255));
        btnVender2.setText("IMPRIMIR ENTRADAS");
        ...
        panel3.add(btnVender2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 580, 170, 50));
    ...
    private void btnVender1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVender1ActionPerformed
        ...
        try {
            ...
            Connection conect = (Connection) con.conexion();
            
            JasperReport reporteV = null;
            String path="src\\reportes\\gastosR.jasper";
            
            reporteV = (JasperReport) JRLoader.loadObjectFromFile(path);
            
            JasperPrint jprint = JasperFillManager.fillReport(reporteV, null, conect);
    ...
    private void btnVender2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVender2ActionPerformed
        try {
            ...
            JasperReport reporteV = null;
            String path="src\\reportes\\ventasR.jasper";
